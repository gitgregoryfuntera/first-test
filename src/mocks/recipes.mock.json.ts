export const recipesMock = [
  {
    ...
    "directions": [
      ...
      {
        "instructions": "In a large skillet, over medium heat, heat 1/2 cup oil in a skillet, add tortilla squares; fry until crisp.",
        "optional": false
      },
      {
      ...
      {
        "instructions": "In another skillet, sauté the onion, pepper, jalapeno and garlic in the remaining 1 tablespoon oil.",
        "optional": false
      },
      {
  ...
  },
  {
    ...
    "directions": [
      ...
      {
        "instructions": "Add the cabbage, thyme, salt, and pepper. Reduce heat; simmer, covered 14-16 minutes or until cabbage is tender.",
        "optional": false
      },
      {
  ...
  },
  {
    ...
    "directions": [
      ...
      {
        "instructions": "Trim the stems of the Brussels sprouts to release outermost leaves, about 5 leaves from each sprout.",
        "optional": false
      },
      {
        "instructions": "Place leaves in the bowl of sauce; toss with your fingers until all the leaves are evenly coated.",
        "optional": false
      },
      {
      ...
      {
        "instructions": "Roast leaves in the preheated oven until wilted and lightly browned, about 15 minutes. Transfer any crispy leaves to a serving plate and continue roasting, removing crispy leaves at 5-minute intervals, until all leaves are crispy, about 10 minutes more.",
        "optional": false
      }
    ]
  },
